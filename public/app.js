...
// R2 public URL set via <meta name="digest-url"> (injected at deploy time)
// Falls back to /digest.json for local dev (generated by npm run digest)
const DIGEST_URL = document.querySelector('meta[name="digest-url"]')?.content || '/digest.json';
